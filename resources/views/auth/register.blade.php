                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Buat Aku Deck?</h1>
                                </div>
                                <form class="user">
...
is-invalid @enderror" id="email" placeholder="Email Address" required name="email" value="{{ old('email') }}">
                                        @error('email')
                                        <span class="invalid-feedback" role="alert">
...
is-invalid @enderror" id="password" placeholder="Password" required name="password">
